...
/**
 * ProductMediumService wird von Product abgeleitet. 
 * @author Cordula Eggerth
 *
 */
public class ProductMediumService extends Product implements Serializable, IOfferComponent {
	 ...
	 * @param plan
	 */
	public ProductMediumService(int productId, String name, String description, double vatPercent, Plan plan) {
	...
	public ArrayList<String> getOfferComponentType() {
		...
		offerComponentType.add("ProductMediumService");
